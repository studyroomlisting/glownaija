    ...
    <div className="card card-body flex justify-between items-center flex-wrap gap-3">
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1 flex-wrap">
          ...
          {profile.is_admin && <span className="badge-pill bg-rose text-white text-[10px]">Admin</span>}
          {profile.account_type === 'owner' && <span className="badge-pill bg-blue-100 text-blue-700 text-[10px]">Owner</span>}
        </div>
